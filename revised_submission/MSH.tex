...
These equations can be used to describe in an average sense a range of melt-melt equilibria involving monomers (Mg(OH)$_2$ and Si(OH)$_4$), dimers (Mg$_2$O(OH)$_2$, MgSiO(OH)$_4$, Si$_2$O(OH)$_6$) and higher oligomers. A high proportion of monomers and dimers exist in relatively dilute solutions \citep{XXXX}, but not in the concentrated solutions investigated in this study.
...
\begin{tabular}{lllll}
Phase & $P_{\textit{\tiny{ref}}}$ ($10^{10}$ Pa) & A [$10^{-12}$ kg/(kgPa)] & $\Delta H_{P_{\textit{\tiny{ref}}}}$ [$10^{5}$ J/mol] & $\Delta V$ [$10^{-5}$ m$^3$/mol] \\
\hline
